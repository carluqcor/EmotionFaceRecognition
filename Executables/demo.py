...
if __name__ == "__main__":
    ...
    operation = AVG
    windowSize = 1
    modelName = 'Modelos/vgg19_8.h5'
    descriptorType = 2
    confidenceArg = 0.75
    faceDescriptor = cv2.dnn.readNetFromCaffe('Modelos/deploy.prototxt.txt', 'Modelos/res10_300x300_ssd_iter_140000.caffemodel')
    ...
    for opt, arg in opts:
        if opt in ('-w', '--windowSize'):
            ...
            if str(arg) == 'DLIB' or str(arg) == 'dlib':
                ...
                faceDescriptor = cv2.CascadeClassifier('Modelos/haarcascade_frontalface_default.xml')
                descriptorType = 1
